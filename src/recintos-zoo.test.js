...
describe('Recintos do Zoologico', () => {
    ...
    test('Deve rejeitar quantidade inválida', () => {
        const resultado = new RecintosZoo().analisaRecintos('MACACO', 'aaaa');
        expect(resultado.erro).toBe("Quantidade inválida");
        expect(resultado.recintosViaveis).toBeFalsy();
    });
    ...
    test('Deve rejeitar quantidade inválida para LEOPARDO', () => {
    ...
    test('Não deve encontrar recinto para 2 leopardo', () => {
        const resultado = new RecintosZoo().analisaRecintos('LEOPARDO', 2);
        expect(resultado.erro).toBe("Não há recinto viável");
        expect(resultado.recintosViaveis).toBeFalsy();
    });

    test('Deve rejeitar quantidade inválida para crocodilo', () => {
